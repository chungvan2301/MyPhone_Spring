...
function setBorder() {
    ...
    var typeInput = document.getElementById("type-input").value;
    colorDivs.forEach(function (div) {
                    var p = div.querySelector('p'); // Lấy thẻ p bên trong div
                    if (p.innerText === colorInput) {
                        div.classList.add('border-danger'); // Thêm class "true" nếu thỏa điều kiện
                        div.style.backgroundColor = "#F08080";
                        div.classList.remove('border-secondary');
                    } else {
                        div.classList.remove('border-danger'); // Gỡ class "true" nếu không thỏa điều kiện
                        div.style.backgroundColor = "white";
                    }
                });
    typeDivs.forEach(function (div) {
                    var p = div.querySelector('p'); // Lấy thẻ p bên trong div
                    if (p.innerText === typeInput) {
                        div.classList.add('border-danger'); // Thêm class "true" nếu thỏa điều kiện
                        div.style.backgroundColor = "#F08080";
                        div.classList.remove('border-secondary');
                    } else {
...
function submitColor(atr) {
    var colorInput = document.getElementById("color-input");
    var elementText = document.getElementById("color"+atr).innerText;
    colorInput.value = elementText;
    console.log(elementText);
    document.getElementById("submit-product").click();
}

function submitType(atr) {
    var elementText = document.getElementById("type"+atr).innerText;
    var typeInput = document.getElementById("type-input");
    typeInput.value = elementText;
    document.getElementById("submit-product").click();
}